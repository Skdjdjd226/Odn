...
MakeWindow({
  Hub = {
    Title = "Triple Hub V2",
    Animation = "by : Triple and"
  },
  Key = {
    KeySystem = true,
    Title = "Key System",
    Description = "Join discord for key",
    KeyLink = "https://dsc.gg/triplehubontop",
    Keys = {"Triple Hub"},
    Notifi = {
      Notifications = true,
...
local section = AddSection(Misc, {"Misc"})

local Toggle = AddToggle(Misc, {
  Name = "Night Mode",
  Default = false,
  Callback = function(toggled)
...
local section = AddSection(Credits,{"Credit to triple"})

AddButton(Credits, {
  Name = "Triple discord",
  Callback = function()
  setclipboard("https://dsc.gg/triplehubontop")
    print("test")
  end
})
