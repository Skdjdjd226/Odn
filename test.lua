...
--start, the real one
local Mainy = Tabs.Combat:AddSection("Main")

Mainy:AddParagraph({
        Title = "NEWS",
        Content = "Added more features"
    })
...
local Money = Tabs.Crates:AddSection("Features")
...
--settings
local Settings = Tabs.Settings:AddSection("Settings")

local Toggle = Settings:AddToggle("Night mode", {Title = "night mode ", Default = false })
Toggle:OnChanged(function(toggled)
...
local Toggle = Settings:AddToggle("Trail", {Title = "Trail ", Default = false })
Toggle:OnChanged(function(toggled)
...
local Toggle = Settings:AddToggle("Spectate Ball", {Title = "Spectate Ball", Default = false })
Toggle:OnChanged(function(toggled)
...
Credits:AddParagraph({
        Title = "triple",
        Content = "Made by Triple or triplescript on discord"
    })
...
setclipboard("https://discord.com/invite/zUFm796w")  
        end
    })
